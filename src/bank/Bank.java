            ...
            try{
                do{
                    str = JOptionPane.showInputDialog(null, "Masukkan"
                            + "4 Digit PIN Anda :","ATM BNI SYARIAH-KEDIRI",0);
                            ...
                            if (pin==1234) //cek pin
                                do{
                                    str = JOptionPane.showInputDialog(null,"[1] INFORMASI SALDO \n"
                                            + "[2] PENYETORAN \n[3] PENARIKAN \n[4] PETUNJUK \n[5] KELUAR"
                                            + "\n\nMasukkan Pilihan Menu:","Pilih Tansaksi",3);
                                    choice = Integer.parseInt(str);
        switch (choice){
            case 1:
                JOptionPane.showMessageDialog(null,"Saldo Anda saat ini sebesar : " + tab); //informasi saldo
                z=JOptionPane.showConfirmDialog(null,"Melanjutkan transaksi lain?","ATM BNI SYARIAH-KEDIRI", 
            ...
            default: JOptionPane.showMessageDialog(null,"Pilihan menu tidak tersedia\nSilahkan ulangi lagi","ERROR",0);
                        ...
                        while (1==1);
                            else if (counter<3){ //ika pin salah
                                a--; //menghitung kesalahan logi dan memberikan kesempatan login
